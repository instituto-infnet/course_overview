...
class main implements renderable, templatable {
    ...
    private function process_tab($output, $favtab, $tab) {
        ...
        foreach ($tab->sortedcourses as $course) {
            ...
            $course->categorylink = new \moodle_url('/course/index.php', array('categoryid' => $course->category));
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $tabs = array(
            ...
            2 => (object) [
                'tab' => 'blocos',
                'isblocos' => true,
                'show' => $this->selectedtab == 'blocos' ? 'show active' : '',
                'data' => $this->process_tab($output, false, $this->tabs['blocos']),
                ],
        );
